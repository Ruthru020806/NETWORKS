...
int main() {
    ...
    insertURL("instagram.com",  "157.240.22.35",   "F0:2F:74:6B:88:11");
    insertURL("flipkart.com",    "205.251.242.103", "B8:27:EB:9A:3C:44");
    insertURL("mepcoeng.ac.in", "172.16.16.1",  "00:1A:2B:3C:4D:5E");
        ...
        for (b = 0; b < packetSize; b++) 
	{
        ...
        printf("  Src IP    : %s\n", srcIPBin);
        printf("  Dst IP    : %s\n\n", dstIPBin);*/
	printf("\n%s%s%s%s%s\n\n",srcIPBin,dstIPBin,srcPortBin,dstPortBin,bits);
    }
    printf("===============================================\n\n");
    ...
    for (p = 0; p < numPackets; p++) {
        ...
        for (f = 0; f < framesPerPacket; f++) {
            ...
            printf("  Dst MAC  : %s\n", dstMACBin);
            printf("  Trailer  : %s\n\n", trailer);*/
	    printf("\n%s%s%s%s%s%s%s%s\n\n",srcMACBin,dstMACBin,srcIPBin,dstIPBin,srcPortBin,dstPortBin,bits,trailer);
        }
    }
    printf("=================================================\n\n");
